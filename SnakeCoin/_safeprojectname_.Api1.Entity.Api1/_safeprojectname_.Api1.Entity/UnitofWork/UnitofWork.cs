...
namespace _safeprojectname_.Api1.Entity.UnitofWork
{
    ...
    public interface IUnitOfWork: IDisposable
    {
        ...
        _safeprojectname_.Api1Context Context { get; }
        bool Save();
        Task<bool> SaveAsync();
    }
    ...
    {
        public _safeprojectname_.Api1Context Context { get; }

        private Dictionary<Type, object> _repositoriesAsync;
        private Dictionary<Type, object> _repositories;
        private bool _disposed;

        public UnitOfWork(_safeprojectname_.Api1Context context)
        {
            Context = context;
            _disposed = false;
        }
